...
namespace Regex
{
    ...
    public class StringUtilsTests
    {
        ...
        [Test]
        public void PasswordValidator_ShouldReturnTrueForValidPasswords()
        {
            Assert.IsTrue(_passwordValidator.IsValid("StrongP@ss1"));
        }

        [Test]
        public void PasswordValidator_ShouldReturnFalseForShortPassword()
        {
            Assert.IsFalse(_passwordValidator.IsValid("Short1"));
        }

        [Test]
        public void PasswordValidator_ShouldReturnFalseForMissingUppercase()
        {
            Assert.IsFalse(_passwordValidator.IsValid("weakpassword1"));
        }

        [Test]
        public void PasswordValidator_ShouldReturnFalseForMissingDigit()
        {
            Assert.IsFalse(_passwordValidator.IsValid("NoDigitHere"));
        }
    }
